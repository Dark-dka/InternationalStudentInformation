        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Kontrakt qoldigʻi</TableCell>
              <TableCell align="right">Roʻyxatga olish qoldigʻi</TableCell>
              <TableCell align="center">Roʻyxatdan qolgan kunlar</TableCell>
                ...
                <TableRow key={student.id} hover>
                  ...
                  <TableCell align="center">
                    {student.dormitory.status === 'None' ? (
                      <Chip
                        size="small"
                        label="Yotoqxona yoʻq"
                        variant="outlined"
                      />
                    ) : (
                      <Chip
                        size="small"
                        label={`${student.dormitory.status} • $${
                          dormitoryBalance.balance > 0
